...
router3 = {"device_type": "huawei", "host": "172.16.4.203", "username": "user", "password": "b402b402", "session_log": f"router3_{datetime.now().strftime("%Y%m%d-%H%M%S")}.log"}
router4 = {"device_type": "huawei", "host": "172.16.4.204", "username": "user", "password": "b402b402", "session_log": f"router4_{datetime.now().strftime("%Y%m%d-%H%M%S")}.log"}
