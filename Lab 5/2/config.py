from huawei import switch1, switch2, router1, HuaweiSwitch
from pathlib import Path

if __name__ == "__main__":
    script_dir = Path(__file__).parent
    log_dir = script_dir / "log"
    config_switch1 = script_dir / "弱电箱交换机.txt"
    config_switch2 = script_dir / "客厅交换机.txt"
    ...
    with HuaweiSwitch(router1, log_dir=log_dir) as R1:
